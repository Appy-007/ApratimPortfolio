    ...
    return (
        ...
        <div id="home" className="pt-20 flex flex-col gap-4 items-center mb-20">
           ...
           <div className="flex flexx-col sm:flex-row items-center  gap-4">
            ...
            <a className="rounded-full px-1 md:px-4 py-1 md:py-2 border border-black  text-center flex items-center gap-2  text-xs nd:text-sm">My resume <Image src={assets.download_icon} alt="download_icon" className="w-3"/></a>
           </div>
        </div>
        </>
    )
